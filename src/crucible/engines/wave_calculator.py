...
MB.10.4 — ``wave-size-exceed`` is now the SOLE consumer: the concurrent-
modification and deletion checks were rebuilt on the static file graph
(dependency reachability), so they no longer need a wave timeline.
"""
