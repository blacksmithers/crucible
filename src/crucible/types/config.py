...
The runtime config is a plain nested ``dict`` matching the object literal
...
# Ticket complexity buckets (config-level counterpart of models.Complexity).
...
# resolver access it by string key, exactly as the object literal is read.
